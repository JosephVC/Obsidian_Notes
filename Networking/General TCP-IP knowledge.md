...
- What is an IP address?
	...
	- these are a 32 bit address in IPv4 - 000.000.000.000
		- now there too many devices for IPv4 to cover so now we have IPv6, which  uses 128 bits 
		- 
...
-  What are some common network troubleshooting utilities used to test connectivity?  ping, wget, curl, etc.
	- 
-  What are some common Unix/Linux command line text editors? Are you comfortable using them? vim, nano , emacs, etc.
	- 
